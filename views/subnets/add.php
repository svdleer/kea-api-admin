...
<body class="bg-gray-100">
    ...
    <div id="loadingOverlay" class="fixed inset-0 bg-black bg-opacity-50 hidden z-50">
        <div class="flex items-center justify-center min-h-screen">
            <div class="bg-white p-6 rounded-lg shadow-xl">
                ...
                <p class="mt-4 text-gray-700">Creating subnet...</p>
            </div>
        </div>
    </div>
    ...
    <div class="min-h-screen py-8">
        <div class="max-w-4xl mx-auto px-4">
            ...
            <div class="flex justify-between items-center mb-8">
                <div>
                    <h1 class="text-3xl font-bold text-gray-900">Add New Subnet</h1>
                    <p class="mt-2 text-sm text-gray-600">Create a new network subnet</p>
                </div>
                <a href="/subnets" class="btn btn-secondary flex items-center space-x-2">
            ...
            <div class="bg-white shadow-lg rounded-lg">
                <form id="addSubnetForm" method="POST" class="p-6 space-y-6">
                    <!-- Name Field -->
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            const form = document.getElementById('addSubnetForm');
            const inputs = {
                name: {
            ...
            form.addEventListener('submit', async function(e) {
                ...
                try {
                    ...
                    const response = await fetch('/api/subnets/create', {
                        method: 'POST',
                        body: formData,
                        headers: {
                    ...
                    if (data.success) {
                        window.location.href = '/subnets?success=Subnet created successfully';
                    } else {
                        throw new Error(data.message || 'Error creating subnet');
                    }
                } catch (error) {
                    alert(error.message);
