...
<div class="container mx-auto px-4 py-8">
    ...
    <div class="mb-6">
        <div class="flex justify-between items-center">
            ...
            <a href="/radius" class="inline-flex items-center px-6 py-3 border border-gray-300 rounded-md shadow-sm text-sm font-medium text-gray-700 bg-white hover:bg-gray-50">
            ...
            <form id="primaryServerForm" class="space-y-4">
                ...
                <div class="flex justify-end space-x-3 pt-4">
                    <button type="button" onclick="testConnection('primary')"
                            class="px-6 py-3 border border-indigo-600 text-indigo-600 rounded-md hover:bg-indigo-50">
                        Test Connection
                    </button>
                    <button type="submit"
