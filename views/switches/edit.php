...
<body class="bg-gray-100">
    ...
    const bviId = $('#bvi_id').val();
        ...
        function isValidHostname(hostname) {
            return /^[A-Z]{2,4}-(?:RC|LC|GT)\d{4}-AR\d{3}$/.test(hostname);
        }
        ...
        hostnameInput.on('input', function() {
            ...
            if (!isValidHostname(value)) {
                ...
                validationMessage.text('Invalid format. Must be 2-4 chars followed by -RC/LC/GT + 4 digits-AR + 3 digits (e.g., AMST-GT0001-AR001)').removeClass('text-green-600').addClass('text-red-600').removeClass('hidden');
