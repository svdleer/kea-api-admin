                                    ...
                                    <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500">
                                        <div class="flex items-center space-x-2">
                                            <button onclick="editReservation(${JSON.stringify(host).replace(/"/g, '&quot;')})" 
                                                    class="inline-flex items-center px-2 py-1 text-sm text-blue-600 hover:text-blue-900 hover:bg-blue-50 rounded">
                                            ...
                                            <button onclick="deleteReservation('${host['ip-addresses'][0]}', ${host['subnet-id']})" 
                                                    class="inline-flex items-center px-2 py-1 text-sm text-red-600 hover:text-red-900 hover:bg-red-50 rounded">
                                                <svg class="w-4 h-4 mr-1" fill="none" stroke="currentColor" viewBox="0 0 24 24">
